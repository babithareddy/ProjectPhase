...
public class TwitterActivity extends ActionBarActivity implements OnClickListener{
    ...
    Button mBtnTwitter;
    private static final String CONSUMER_KEY = "jzKDfAy818FpvoTkuy52p8viv";
    private static final String CONSUMER_SECRET = "6CdGBzY0An6xQOvNDg2XhItWUiF69XXF7SM3SAg5g0eNA3I1B6";
